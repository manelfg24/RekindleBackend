...
public class UserServiceImpl implements UserService {
	...
	public String createRefugee(String mail, String password, String name, String surname1, String surname2,
		...
		String creationResult = "Usuario creado con exito";
		try {
			refugeeRepository.create(mail, password, name, surname1, surname2, phoneNumber, birthdate, sex, country,
...
/*
 * public String createVolunteer(String mail, String password, String name,
 * String surname1, String surname2){
 * System.out.println("Mail "+mail+"   Password "+password); Optional<Volunteer>
 * oVolunteer = volunteerRepository.findOptionalByMail(mail); String
 * creationResult = "El voluntario ya existe"; if(!oVolunteer.isPresent()) {
 * Volunteer v = new Volunteer(); v.setMail(mail); v.setPassword(password);
 * v.setName(name); v.setSurname1(surname1); v.setSurname2(surname2);
 * creationResult = volunteerRepository.save(v); } return creationResult; }
 */
